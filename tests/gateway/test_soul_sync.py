"""Tests for plugins.platforms.skytower.soul_sync — SoulSync class and SkyTower adapter integration."""
import pytest
from pathlib import Path
from unittest.mock import AsyncMock, MagicMock, patch

from plugins.platforms.skytower.soul_sync import SoulSync
...
class TestGetSoulPath:
    ...
    def test_uses_hermes_constants_when_no_home(self, monkeypatch):
        ...
        monkeypatch.setattr("plugins.platforms.skytower.soul_sync.SoulSync._hermes_home", None, raising=False)
