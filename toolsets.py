...
TOOLSETS = {
    ...
    "hermes-skytower": {
        "description": "Skytower Relay toolset - interact with Hermes via Skytower web relay",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
